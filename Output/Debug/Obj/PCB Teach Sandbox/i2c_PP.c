# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 409 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.c" 2
# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.h" 1
...
# 5 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.h" 2
# 15 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.h"
extern unsigned char eeprom_addr = 0x08;
extern unsigned char eeprom_addr_offset = 0;
# 27 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.h"
extern unsigned char IDLE_flag; extern unsigned char IDLE_out; extern unsigned char SEQUENCE_INPUT_flag; extern unsigned char SEQUENCE_INPUT_out;
...
void I2C_init(void);
# 2 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.c" 2
...
# 3 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.c" 2
# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/tools.h" 1
# 4 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.c" 2



unsigned char IDLE_flag; unsigned char IDLE_out; unsigned char SEQUENCE_INPUT_flag; unsigned char SEQUENCE_INPUT_out;


unsigned char eeprom_addr = 0x08;
unsigned char eeprom_addr_offset = 0;

void I2C_TX_device_addr(char device_address, char RW_bit) {
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL)) -> DR = (device_address + RW_bit);

  while((((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR1 & (0x1UL << (1U)))==0) {}
  (void)((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR1;
  (void)((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR2;
}

void I2C_start_gen(void) {
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CR1 |= (0x1UL << (8U));
  while((((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR1 & (0x1UL << (0U))) == 0) {};
}

void I2C_stop_gen(void) {
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CR1 |= (0x1UL << (9U));
}

void I2C_Read(char start_addr, char* data, uint16_t data_len) {

  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CR1 |= (0x1UL << (10U));


  I2C_start_gen();


  I2C_TX_device_addr(0XA0, 0X00);

  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL)) ->DR = start_addr;
  while((((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR1 & (0x1UL << (7U))) == 0) {};


  I2C_start_gen();

  I2C_TX_device_addr(0XA0, 0X01);


  for(uint16_t i =0; i<data_len-1; i++) {
    while((((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR1 & (0x1UL << (6U)))==0) {};
    data[i]=((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->DR;
  }
  ...
  while((((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR1 & (0x1UL << (6U)))==0) {};
  data[data_len-1] = ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->DR;
...
void I2C_Write(char start_addr, char* data, uint16_t data_len) {
  ...
  while((((I2C_TypeDef *) (0x40000000UL + 0x5400UL))-> SR2 & (0x1UL << (1U)))!=0) {};
  ...
  for(uint16_t i =0; i<data_len; i++) {
    ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->DR = data[i];
    while((((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->SR1 & (0x1UL << (7U))) == 0) {};
  }
...
void I2C_init(void) {
  ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)) -> MODER |= (0x2UL << (16U)) | (0x2UL << (18U));
  ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL))->OTYPER |= ((0x1UL << (8U)) | (0x1UL << (9U)));

  ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL))->AFR[1] |= (0x4UL << (0U)) | (0x4UL << (4U));


  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CR2 |= (42 << (0U));
# 109 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/i2c.c"
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CCR = 0;
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CCR |= (210 << (0U));
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CCR &= ~(0x1UL << (15U));

  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->TRISE |= (43 << (0U));
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->OAR1 &= ~((0x1UL << (15U)));

  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CR1 |= (0x1UL << (0U));
  ((I2C_TypeDef *) (0x40000000UL + 0x5400UL))->CR1 |= (0x1UL << (10U));
