# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 409 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.c" 2
# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.h" 1
...
# 2 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.h" 2
# 2 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.c" 2
# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/buttons.h" 1



# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/gpio.h" 1



# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/validation.h" 1
# 5 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/gpio.h" 2
# 5 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/buttons.h" 2
# 24 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/buttons.h"
  extern unsigned char BUTTON0_count; extern unsigned char BUTTON0_state; extern unsigned char BUTTON1_count; extern unsigned char BUTTON1_state; extern unsigned char BUTTON2_count; extern unsigned char BUTTON2_state;
# 42 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/buttons.h"
void Buttons_init(void);
void LED_init(void);
extern void (*OnButtonPressed[3])(void);
# 3 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.c" 2
...
void I2C_init(void);
# 4 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.c" 2
# 1 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/fsm.h" 1
...
extern void DetermineState(void);
# 5 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.c" 2

void RCC_Init(void);
void State_flag_gen(void);

uint16_t t;
# 18 "/home/unmanned-john-doe/git/embedded/pcbteach_sandbox/main.c"
struct {
  unsigned char len;
...
int main(void) {
  ...
  ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL)) -> AHB1ENR |= (0x1UL << (4U)) | (0x1UL << (0U)) | (0x1UL << (1U));
  ...
  while(1) {
    ...
    if((((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))->IDR & (0x1UL << (10U)))==0) { if(BUTTON0_count<4) { BUTTON0_count++; BUTTON0_state = 0; } else { BUTTON0_state = 1; OnButtonPressed[0]();;if((((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))->IDR & (0x1UL << (11U)))==0) { if(BUTTON1_count<4) { BUTTON1_count++; BUTTON1_state = 0; } else { BUTTON1_state = 1; OnButtonPressed[1]();; if((((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))->IDR & (0x1UL << (12U)))==0) { if(BUTTON2_count<4) { BUTTON2_count++; BUTTON2_state = 0; } else { BUTTON2_state = 1; OnButtonPressed[2]();;
    State_flag_gen();

    eeprom_addr = 0x08 + eeprom_addr_offset;

    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))-> ODR = ( ~(eeprom_addr_offset & 0x07)) << 13;
  }
}
