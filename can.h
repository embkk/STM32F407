...
#define CAN_RX_FRAME_ID1      0x234   // FRAME_ID сообщений, которые мы принимаем, остальные игнорируем
#define CAN_RX_FRAME_ID2      0x432   // FRAME_ID сообщений, которые мы принимаем, остальные игнорируем
